...
<!-- –≠—Ç–∞ –≤—Å—Ç–∞–≤–∫–∞ –ø–æ–∑–≤–æ–ª—è–µ—Ç –≤—ã–≤–æ–¥–∏—Ç—å –≤–∞–º –¢–û–ü 10 –°–∞–º—ã—Ö –ø–æ–ø—É–ª—è—Ä–Ω—ã—Ö –≤–∏–¥–µ–æ—Ä–æ–ª–∏–∫–æ–≤ –≤ —Å–∞–π–¥–±–∞—Ä–µ	-->
<!-- ù‚† ¢·‚†¢™† ØÆß¢Æ´Ô•‚ ¢Î¢Æ§®‚Ï ¢†¨ íéè 10 ë†¨ÎÂ ØÆØ„´Ô‡≠ÎÂ ¢®§•Æ‡Æ´®™Æ¢ ¢ ·†©§°†‡•	-->


<li>
<h2>–¢–û–ü 10 –°–∞–º—ã—Ö –ø–æ–ø—É–ª—è—Ä–Ω—ã—Ö</h2>
<?php
global $wpdb;
$querystr = "SELECT wposts.* FROM $wpdb->posts wposts, $wpdb->postmeta wpostmeta WHERE wposts.ID = wpostmeta.post_id AND wpostmeta.meta_key = 'rating' AND wposts.post_status = 'publish' ORDER BY (wpostmeta.meta_value+1.0) DESC limit 10";
$pageposts = $wpdb->get_results($querystr, OBJECT);
?>
<center><?php foreach($pageposts as $post): setup_postdata($post); ?>
<p><a href="<?php the_permalink() ?>" title="BEST - <?php the_title(); ?>"><img alt="BEST - <?php the_title(); ?>" src="<?php echo get_post_meta($post->ID,'scrshot',true) ?>"></a><br />BEST - <?php the_title(); ?></p><br>
<?php endforeach; ?></center>
</li>

<!-- –ö–æ–Ω–µ—Ü –≤—Å—Ç–∞–≤–∫–∏. –í—ã –º–æ–∂–µ—Ç–µ –≤—Å—Ç–∞–≤–∏—Ç—å –ø—Ä–∞–∫—Ç–∏—á–µ—Å–∫–∏ –≤ –ª—é–±—É—é —Å—Ö–µ–º—É WORDPRESS! -->
<!-- äÆ≠•Ê ¢·‚†¢™®. ÇÎ ¨Æ¶•‚• ¢·‚†¢®‚Ï Ø‡†™‚®Á•·™® ¢ ´Ó°„Ó ·Â•¨„ WORDPRESS! -->
